...
const Section1 =()=>{
    ...
    return(
        <section id="section1" className="container flex-col mb-10 pdg">
            ...
            <div className="container flex-space-btw">
                <Para text = "Lorem ipsum dolor sit, amet consectetur adipisicing elit. Sit possimus totam vitae. Alias illum totam voluptas a iste hic nostrum explicabo debitis, tempora nemo commodi iusto necessitatibus eos. Nobis, illo."/>
